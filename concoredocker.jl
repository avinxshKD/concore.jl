# Standalone Docker variant of Concore.jl for the concore ecosystem.
# This is the file that mkconcore.py copies into Docker containers.
# Canonical source: standalone/concoredocker.jl
#
