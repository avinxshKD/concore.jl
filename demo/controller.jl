#=
controller.jl -- Bang-bang controller node for concore demo

Julia equivalent of the Python demo/controller.py.

Run from the node working directory (e.g., CZ/):
    julia --project=/path/to/concore-jl /path/to/concore-jl/demo/controller.jl
=#
